...
namespace QuantConnect.Tests.Algorithm.Framework.Alphas.Serialization
{
    ...
    public class InsightJsonConverterTests
    {
        ...
        public void DeserializesInsightWithScore()
        {
            ...
            Assert.AreEqual(jObject["score-magntidue"].Value<double>(), result.Score.Magnitude);
            Assert.AreEqual(jObject["score-direction"].Values<double>(), result.Score.Direction);
        }
